...
router.get('/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ProductService_1.default.getAllProducts()];
            case 1:
                response = _a.sent();
...
router.post('/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, price, category, description, image, currency, response;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, price = _a.price, category = _a.category, description = _a.description, image = _a.image, currency = _a.currency;
                return [4 /*yield*/, ProductService_1.default.addProduct({ name: name, price: price, category: category, description: description, image: image, currency: currency })];
            case 1:
                response = _b.sent();
                return [2 /*return*/, res.status(200).json(response)];
        }
